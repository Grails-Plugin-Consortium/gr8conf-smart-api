...
//= require thirdparty/jquery.plugins/jquery.cookie
//= require thirdparty/bootstrap/bootstrap.min
//= require thirdparty/prettify
//= require thirdparty/bootstrap.plugins/ekko-lightbox.min
//= require thirdparty/jquery.plugins/jquery.blimagecenter.min
//= require thirdparty/jquery.plugins/jquery.bxslider.min
//= require thirdparty/lodash.compat.min
...
$(function () {
    ...
    $(document).delegate('*[data-toggle="lightbox"]', 'click', function (event) {
        ...
        $(this).ekkoLightbox({
            left_arrow_class: 'fa fa-arrow-left fa-2x',
            right_arrow_class: 'fa fa-arrow-right fa-2x'
        });
    });
    ...
    $(window).resize(function () {
        ...
        if (width > 750) {
            $link.centerImage();
            $link.removeClass('def-img');
        } else {
            $link.addClass('def-img');
        }
    });
