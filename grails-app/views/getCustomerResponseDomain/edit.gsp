...
<body>
	...
	<section id="edit-getCustomerResponseDomain" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${getCustomerResponseDomainInstance?.id}" />
			<g:hiddenField name="version" value="${getCustomerResponseDomainInstance?.version}" />
